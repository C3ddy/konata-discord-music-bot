...
exports.run = async (client, message, args, distube) => {
  ...
  if(args[1] == "donate"){
    embed = {
      "description": "The Command 'donate' sends you a link to donate",
      "color": 9152956,
      "thumbnail": {
        "url": client.user.avatarURL()
      },
      "author": {
        "name": "Bait's Help: donate",
        "url": "",
    ...
    embed = {
      "description": "The Command 'shift' moves a new song to beginning of queue",
      "color": 9152956,
      "thumbnail": {
        "url": client.user.avatarURL()
      },
      "author": {
        "name": "Bait's Help: shift",
        "url": "",
        "icon_url": client.user.avatarURL()
      },
      "fields": [
        {
          "name": "Format",
          "value": prefix + "shift <number>",
          "inline": false
        },
        {
          "name": "Example",
          "value": prefix + "shift 2",
          "inline": false
        },
      ]
    };
    ...
    embed = {
      ...
      embed = {
        ...
        "fields": [
          ...
          {
            "name": "Disclaimer",
            "value": "When using onGoing the bot can only be manually disconnect",
            "inline": false
          },
        ]
      };
      ...
      embed = {
        ...
        "fields": [
          {
            "name": "Music",
            "value": "`play`, `skip`, `stop`, `previous`, `queue`, `loop`, `move`, `shift`, `volume`, `autoplay`, `shuffle`, `filter`, `lyrics`, `resume`",
            "inline": false
          },
          {
            "name": "Premium",
          ...
          {
            "name": "Utility",
            "value": "`help`, `invite`, `vote`, `ping`, `premium`, `donate`",
            "inline": false
          },
          {
            "name": "💠 Vote for Bait",
